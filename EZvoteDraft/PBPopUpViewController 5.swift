...
class PBPopUpViewController: UIViewController {

    @IBOutlet weak var pbText: UITextView!
     
        
        override func viewDidLoad() {
            super.viewDidLoad()
           
            pbText.layer.cornerRadius = 10.0
    ...
    @IBAction func closePB(_ sender: Any) {self.view.removeFromSuperview()
        }
