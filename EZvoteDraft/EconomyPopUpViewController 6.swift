//
//  EconomyPopUpViewController.swift
//  EZvoteDraft
//
...
class EconomyPopUpViewController: UIViewController {

    @IBOutlet weak var econText: UITextView!
     
     override func viewDidLoad() {
         super.viewDidLoad()
        
         econText.layer.cornerRadius = 10.0
    ...
    @IBAction func closeEcon(_ sender: Any) {
