//
//  AbortPopUpViewController.swift
//  EZvoteDraft
//
...
class AbortPopUpViewController: UIViewController {

     @IBOutlet weak var LGBTQText: UITextView!
       
          
          override func viewDidLoad() {
              super.viewDidLoad()
             
              LGBTQText.layer.cornerRadius = 10.0
       ...
       @IBAction func LGBTQclose(_ sender: Any) {self.view.removeFromSuperview()
           }
